                            ...
                            <div class="form-validation">
                                <form class="form-valide" action="./home.php" method="post" novalidate="novalidate">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="idusername" name="idusername" value="000" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="nameth" name="nameth" value="ภัทรพร" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="lnameth" name="lnameth" value="แซ่ตั้น" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="fnameEn" name="fnameEn" value="Phattaraporn" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="lnameEn" name="lnameEn" value="Saeton" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="NickName" name="NickName" value="ภัทร" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="position" name="position" value="ERP" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="phone" name="phone" value="0950427705" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="Email" name="Email" value="phattaraporn.sa@universalrice.com" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="call" name="call" value="214" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-number" name="val-number" value="IT" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-range" name="val-range" value="IT" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
