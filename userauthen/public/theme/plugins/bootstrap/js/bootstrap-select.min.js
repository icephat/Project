            ...
            render: function (b) {
                ...
                var e = this.options.hideDisabled ? ":not([disabled])" : "",
                    f = this.$element
                        ...
                        .toArray(),
                    g = this.multiple
                        ? f.join(this.options.multipleSeparator)
                        : f[0];
                if (
                    this.multiple &&
                ...
                if (
                    ...
                    var s = function () {
                        ...
                        r(),
                            ...
                            (a =
                                h.length + h.filter(".dropdown-header").length >
                                3
                                    ? 3 * i + q - 2
                                    : 0),
                            f.css({
            ...
            selectPosition: function () {
                var b,
                    ...
                    g = function (a) {
                        f
                            .addClass(
                                a.attr("class").replace(/form-control/gi, "")
                            )
            ...
            liveSearchListener: function () {
                ...
                this.$newElement.on("click.dropdown.data-api", function () {
                    b.$menu.find(".active").removeClass("active"),
                        ...
                        b.multiple ||
                            b.$menu.find(".selected").addClass("active"),
                        setTimeout(function () {
                            b.$searchbox.focus();
                        }, 10);
                }),
                    this.$searchbox.on("input propertychange", function () {
                        b.$searchbox.val()
                            ? (b.options.searchAccentInsensitive
                              ...
                              b.$menu
                                  .find("li")
                                  .filter(":visible:not(.no-results)").length
                                  ? e.parent().length && e.remove()
                                  : (e.parent().length && e.remove(),
                                    e
                                        .html(
