...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2022 at 04:23 PM
...
--
ALTER TABLE `imgdisease`
  MODIFY `imgDiseaseID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `imgnaturalenemy`
  MODIFY `imgNaturalEnemyID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `imgpest`
--
ALTER TABLE `imgpest`
  MODIFY `imgPestID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `imgvariety`
  MODIFY `imgVarietyID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pathogen`
  MODIFY `pathogenID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pest`
  MODIFY `pestID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pestmanagement`
--
ALTER TABLE `pestmanagement`
  MODIFY `pestManagementID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `targetofsurvey`
  MODIFY `targetOfSurveyID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `variety`
  MODIFY `varietyID` int(11) NOT NULL AUTO_INCREMENT;
