			...
			<div class="card">
				<div class="card-body" style="padding: 5px">
					<div class="text-center">
						...
						<h3>
							<!--  <a
								href="${pageContext.request.contextPath}/approve/approved/${id}/${img.imgSurveyTargetPointId}/page/${page}/value/${value}">
								<i class="fa fa-check text-green" aria-hidden="true"></i>
							</a> -->
							<c:choose>
						    <c:when test="${dateInfoStart!=NULL&&dateInfoEnd!=NULL}">
						       
						      
						<!--		
								<form action="${pageContext.request.contextPath}/approve/reject/date/${id}/${img.imgSurveyTargetPointId}/page/${page}/value/${value}">
										...
										<!--  <button type="submit" class="none" name="status" value="Approved"  >
										    <i class="fa fa-check text-green" ></i>
										</button> -->
										<button type="button" class="none"  onclick="editSuccessDate('Reject',${img.imgSurveyTargetPointId})" >
										    <i class="fa fa-times text-warning"  ></i>
										</button>
										<button type="button" class="none"  onclick="editSuccessDate('Delete',${img.imgSurveyTargetPointId})" >
							...
							<button type="button" class="none" onclick="editSuccess('Reject',${img.imgSurveyTargetPointId})" >
								<i class="fa fa-times text-warning" aria-hidden="true" id = "reject"></i>
							</button>
							<button type="button" class="none"  onclick="editSuccess('Delete',${img.imgSurveyTargetPointId})" >
							...
							<!--  <a
								...
								href="${pageContext.request.contextPath}/approve/success/reject/${id}/${img.imgSurveyTargetPointId}/page/${page}/value/${value}">
