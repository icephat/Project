<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
									...
									<div class="card-body">
										...
										<p align="right">
											<a href="${pageContext.request.contextPath}/approve/index"
												class="btn mb-1 btn-light">เลือกโรคใหม่ <span
													class="btn-icon-right"><i class="fa fa-repeat"></i></span></a>
										...
										<c:if test="${MaxSize==0}">
											<br><br><br><br><br>
											<br><br><br><br><br>
											<h1 align="center">ไม่มีภาพไม่อนุมัติ</h1>
											<br><br><br><br><br>
											<br><br><br><br><br>
										</c:if>
										<c:if test="${MaxSize!=0}">
											<h3 align="left">ภาพที่ไม่อนุมัติ</h3>
											<br>
											<div class="row">
												<div class="col-lg-12">
													<div class="form-validation">
														<form
															action="${pageContext.request.contextPath}/approve/find/reject/${id}/page/${page}/value/${value}"
															...
															<a class="btn btn-light"
																href="${pageContext.request.contextPath}/approve/reject/${id}">ทั้งหมด</a>
														</form>
													</div>
												</div>
											</div>
															...
															<c:choose>
																<c:when test="${statusDate}">
																	<form class="form-valide"
																		action="${pageContext.request.contextPath}/approve/delete/date/${id}/page/${page}/value/${value}"
																...
																<c:otherwise>
																	<form class="form-valide"
																		action="${pageContext.request.contextPath}/approve/delete/${id}/page/${page}/value/${value}"
																		method="POST"
	...
	***********************************-->
				...
				<script>
					function editRejectDate(type, a) {
						
						let textDelete = "คุณยืนยันที่จะลบหรือไม่";
						if(type==="Delete") {
						...
						$
							.ajax({
								type: 'POST',
								url: "${pageContext.request.contextPath }/approve/reject/edit/date/${id}/" + a + "/page/"
									+ pageNumber
								...
								success: function (response) {
									...
									$('#imglist')
										.html(response);
									$('#statusbutton').attr("action", "${pageContext.request.contextPath}/approve/delete/date/${id}/page/${page}/value/" + pageSizeSelected);
									$('#pageNum').attr("value", pageNumber);
									// var size = document
									// 	.getElementById("sizenow").value;
									// $('#listItem2').empty();
									// var first = document
									...
									if(size==0){
										 window.location.href="${pageContext.request.contextPath}/approve/reject/${id}";
									}
									...
									function paginateOption(pageSize, keyPath, totalItem) {
										var options = {
											...
											callback: function (response, pagination) {
												...
												$.ajax({
													method: "GET",
													url: "${pageContext.request.contextPath}/success/index/page/date/${id}/" + pageNumber + "/value/" + pageSize + keyPath,
													success: function (response) {
														// $('#imglist').empty();
										...
										var options = {
											...
											callback: function (
												...
												$
													.ajax({
														method: "POST",
														url: "${pageContext.request.contextPath }/approve/reject/date/list/${id}/page/"
															+ pageNumber
															+ "/value/"
															+ pageSizeSelected,
														data: {
				...
				<script>
					function editReject(type, a) {
						...
						$
							.ajax({
								type: 'POST',
								url: "${pageContext.request.contextPath }/approve/reject/edit/${id}/" + a + "/page/"
									+ pageNumber
									+ "/value/" + pageSizeSelected,
								data: {
								...
								success: function (response) {
									...
									$('#imglist')
										.html(response);
									$('#statusbutton').attr("action", "${pageContext.request.contextPath}/approve/delete/${id}/page/${page}/value/" + pageSizeSelected);
									$('#pageNum').attr("value", pageNumber);
									// var size = document
									// 	.getElementById("sizenow").value;
									// var first = document
									...
									$('#listItem').html(
										'<div class="col-lg-6" id="listItem"><span>รายการที่ ' + firstItem +
										' ถึง ' + lastItem + ' จาก ' + size + ' รายการ</span></div>');
									//container.pagination(paginateOption(pageSizeSelected,size));
									var container = $("#pagination");
									if (!container.length)
										return;
									function paginateOption(pageSize, keyPath, totalItem) {
										var options = {
											...
											callback: function (response, pagination) {
												...
												$.ajax({
													method: "GET",
													url: "${pageContext.request.contextPath}/success/index/page/${id}/" + pageNumber + "/value/" + pageSize + keyPath,
													success: function (response) {
														// $('#imglist').empty();
														// $('#imglist').html(response);
														firstItem = document.getElementById("firstItem").value;
										...
										var options = {
											...
											callback: function (
												...
												$
													.ajax({
														method: "POST",
														url: "${pageContext.request.contextPath }/approve/reject/list/${id}/page/" +
															pageNumber +
															"/value/" +
															pageSizeSelected,
														success: function (
															...
															$('#imglist')
																.html(
																	response);
															$('#buttonn').attr("action",
																"${pageContext.request.contextPath}/approve/delete/${id}/page/${page}/value/" +
																pageSizeSelected);
															$('#pageNum').attr("value", pageNumber);
															$('#pageNum').attr("value", pageNumber);
															firstItem = document.getElementById("firstItem").value;
				...
				<script>
					...
					if (!dateIsValid(dateInfoStart) || !dateIsValid(dateInfoEnd)) {
						$(function () {
							...
							$.ajax({
								method: "GET",
								url: "${pageContext.request.contextPath}/reject/index/total/${id}",
						...
						function paginateOption(pageSize, keyPath, totalItem) {
							var options = {
								...
								callback: function (response, pagination) {
									...
									$.ajax({
										method: "GET",
										url: "${pageContext.request.contextPath}/reject/index/page/${id}/" + pageNumber + "/value/" + pageSize + keyPath,
										success: function (response) {
											$('#imglist').empty();
											$('#imglist').html(response);
											firstItem = document.getElementById("firstItem").value;
						...
						$(function () {
							...
							$.ajax({
								method: "GET",
								url: "${pageContext.request.contextPath}/reject/index/total/date/${id}",
								data: {
									dateInfoStart: $('#dateInfoStart').val(),
									dateInfoEnd: $('#dateInfoEnd').val(),
								}
						...
						function paginateOption(pageSize, keyPath, totalItem) {
							var options = {
								...
								callback: function (response, pagination) {
									...
									$.ajax({
										method: "GET",
										url: "${pageContext.request.contextPath}/reject/index/page/date/${id}/" + pageNumber + "/value/" + pageSize + keyPath,
										data: {
											dateInfoStart: $('#dateInfoStart').val(),
											dateInfoEnd: $('#dateInfoEnd').val(),
										},
					...
					if (!dateIsValid(dateInfoStart) || !dateIsValid(dateInfoEnd)) {
										...
										$
											.ajax({
												...
												success: function (response) {
													...
													$('#imglist').html(
														response);
													$('#buttonn').attr("action", "${pageContext.request.contextPath}/approve/delete/${id}/page/${page}/value/" + pageSizeSelected);
													$('#pageNum').attr("value", pageNumber);
													$('#listItem2').empty();
													var first = document
														.getElementById("firstitem").value;
						...
						$(function () {
							$("#itemSize")
								.change(
									function () {
										var pageNumber = document
											.getElementById("pageNum").value;
										pageSizeSelected = $(
											"#itemSize option:selected")
											.val();
										$
											.ajax({
												type: 'POST',
										...
										$
											.ajax({
												...
												success: function (response) {
													...
													$('#imglist')
														.html(response);
													$('#statusbutton').attr("action", "${pageContext.request.contextPath}/approve/edit/reject/date/${id}/page/${page}/value/" + pageSizeSelected);
													$('#pageNum').attr("value", pageNumber);
													$('#listItem2').empty();
													var first = document
														.getElementById("firstitem").value;
							...
							$("#itemSize")
								.change(
									function () {
										...
										pageSizeSelected = $("#itemSize option:selected").val();
										$
											.ajax({
												method: "POST",
												url: "${pageContext.request.contextPath }/approve/reject/date/list/${id}/page/"
