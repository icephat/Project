								...
								<div class="form-input-content">
									<div class="card login-form mb-0">
										<div class="card-body pt-5">
											...
											<form class="mt-5 mb-5 login-input" action="/cassava/register/staff/confirm"
												method="post">
												<div class="form-group">
													<label class="form-check-label" style="margin-left: 30px;"> <input
														...
														<br> <input type="checkbox" class="form-check-input" value="1"
															name="check2">เลือกข้อนี้เพื่อยอมรับกับประกาศสาธารณสมบัติข้างต้น
													</label>
													<p><span class="text-danger"></span></p>

													<c:if test="${check == 0}">
														<span
															style="color: red; margin-left: 10px;">กรุณากดยอมรับเงื่อนไขทั้ง
															2 ข้อ</span>
													</c:if>
												</div>
												<p align="center">
