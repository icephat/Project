...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">การเพาะปลูก</h4>
							<p align="right">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group row">
										<label class="col-lg-3 col-form-label" for="keyword">ค้นหาการเพาะปลูก
										</label>
										<div class="col-lg-3">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control" id="keyword"
												name="keyword" placeholder="รหัส,ชื่อการเพาะปลูกและชื่อแปลง">
									...
									<input class="inputerror" id="searchCheck" cssClass="error" disabled />
									</div>
								</div>
							</div>
	...
	<script>
		...
		$(function() {
			...
			$
					.ajax(
							{
								method : "GET",
								url : "${pageContext.request.contextPath}/planting/total",
							}).then(
		...
		// search
		document
				.getElementById("search").addEventListener("click",
						function() {
							$('#searchCheck').val('');
							...
							if(!(dateIsValid(startDate) && dateIsValid(endDate))){
								...
								$('#searchCheck').val('กรุณาระบุวันที');
			...
			var options = {
				...
				callback : function(response, pagination) {
					...
					$
							.ajax({
								method : "GET",
								url : "${pageContext.request.contextPath}/planting/page/"
										+ pageNumber
										+ "/value/"
										+ pageSize
