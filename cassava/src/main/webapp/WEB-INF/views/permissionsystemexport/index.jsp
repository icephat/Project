											...
											<tbody>
												<c:forEach items="${requests}" var="request"
													...
													<tr>
														...
														<td><div class="row" style="margin-left: 3px">

																<div>
																	<a
																		href="${pageContext.request.contextPath}/permissionexport/system/requestDelete/${request.requestId}"
																		class="btn btn-danger" role="button"><i
																		class="fa fa-trash" aria-hidden="true"></i></a>
																	<c:if test="${request.status.equals('Approve')}">
																		<c:choose>
																			<c:when test="${request.dateExpire>=now}">
																				<a
																					href="${pageContext.request.contextPath}/permissionexport/system/export/${request.requestId}"
