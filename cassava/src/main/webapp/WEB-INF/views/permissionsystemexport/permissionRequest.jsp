	...
	***********************************-->
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">ส่งออกการสำรวจของระบบ > ขอส่งออกการสำรวจของระบบ >
								สิ่งสำรวจ  </h4>
							<p align="right">
								<a
									href="${pageContext.request.contextPath}/permissionexport/system/permissions"
									class="btn btn-light" role="button">กลับ</a>
							</p>
							<div class="card">
								<div class="card-body">
									<form
										action="${pageContext.request.contextPath }/permissionexport/system/permission/${permissionId}/search"
										method="post">
										...
										<div class="form-group row">
											...
											<div class="col-md-3">
												...
												<select name="province" id="province" class="form-control selectpicker"
													multiple required="required" data-live-search="true" >
							...
							<div class="card">
								<div class="card-body">
									<label><input type="checkbox" id="select-all">
										เลือกทั้งหมด</label>
									<form
										action="${pageContext.request.contextPath }/permissionexport/system/requestSave"
	...
	function selectOptionsFromServerData(serverData, dropdownId) {
	 ...
	 var diseaseidFromServer = '${diseaseid}';
	  ...
	  var organizationidFromServer = '${organizationid}';
	  selectOptionsFromServerData(organizationidFromServer, "organization");
	...
	$(document).ready(function() {
		  ...
		  $('.selectpicker').on('changed.bs.select', function(e, clickedIndex, isSelected, previousValue) {
			...
			if(id==='province'){
				var provinceIds = []; 
				  <c:forEach items="${listprovince}" var="province">
				  provinceIds.push('${province.provinceId}'); 
				  </c:forEach>
		    	...
		    	var organizationIds = []; 
				  ...
				  if (clickedIndex === 0 && isSelected) {
			    	...
			    	$(this).find('option:eq(0)').prop('selected', false);
			    }else if (previousValue.length+1 === organizationIds.length && isSelected){
