		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">ส่งออกการสำรวจของระบบ > ขอส่งออกการสำรวจของระบบ</h4>
							<p align="right">
								<a
										...
										<c:forEach items="${permissions}" var="permission"
											...
											<tr>
												...
												<td><c:forEach
														...
														<c:if test="${targetOfSurveyAndCount[1]!=0}">
												...
												<td><c:if test="${permission.status.equals('Approve')}">
														...
														<c:when test="${!i}">
																<p  style="text-align: center;">ไม่มีการสำรวจ</p>
															</c:when>
															<c:when test="${now <= permission.dateExpire}">
																<form
																	action="${pageContext.request.contextPath}/permissionexport/system/permission/${permission.permisisonId}"
																	method="post">
