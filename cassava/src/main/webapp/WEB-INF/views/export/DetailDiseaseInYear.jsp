						...
						<div class="card-body">
							...
							<p class="card-text">
								<label class="col-lg-4">ปีที่ตรวจสอบภาพ</label> <label
									class="col-lg-6">${year} </label>
							</p>
							<p class="card-text">
								<label class="col-lg-4">โรค</label>
										...
										<tbody>
											<c:forEach items="${size}" var="size" varStatus="loop">
												<tr>
													...
													<td>${size} MB</td>
													<td><button type="submit" name="imgid"
															value="${imgid[loop.index]}"
							...
							<form class="form-valide"
								...
								<p align="center">
									<c:forEach items="${listdiseaseid}" var="diseaseid">
									 ...
									 <input type="hidden"
										name="yearselect" value="${year}"> <input type="submit"
										class="btn btn-primary" value="กลับ" />
								</p>
							</form>
						</div>
