					...
					<div class="card">
						<div class="card-body">
							...
							<div class="form-validation">
								<form class="form-valide" id="organizationData" method="post"
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" name="name"
												value="${organization.name}" placeholder="">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" name="phone"
												value="${organization.phone}" placeholder="" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))||event.charCode == 45">
											<input type="text" class="inputerror" id="phone" disabled/>
										</div>
									</div>
									<!-- 
									<div class="form-group row">
		...
		$(function () {
			...
			$("#button").click(
				...
				function () {
					...
					$("#phone").val("");
					$.ajax({
						url: "${pageContext.request.contextPath}/organization/save",
						type: 'POST',
						data: formData,
						dataType: 'json',
