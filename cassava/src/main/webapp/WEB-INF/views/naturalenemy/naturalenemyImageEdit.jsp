		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">ศัตรูธรรมชาติ > ${targetofsurvey.name} > แก้ไขภาพ</h4>
							<div class="row">
										...
										<div class="card">
											<div class="card-body">
												<div class="text-center">
													...
													<h3>
														<a
															href="${pageContext.request.contextPath}/naturalenemy/image/delete/${img.imgNaturalEnemyId}"
							...
							<div class="form-validation">
								<form class="form-valide"
									action="${pageContext.request.contextPath }/naturalenemy/image/save"
									method="post" modelAttribute="naturalEnemyDTO"
