		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">อนุมัติสิทธิ์ส่งออกการสำรวจของระบบ</h4>
							<p align="right">
								<a
									href="${pageContext.request.contextPath}/permissionsystem/request/approved"
									...
									<tbody>
										<c:forEach items="${permissions}" var="permission"
											...
											<tr>
												...
												<td><c:forEach
														items="${permission.permissionOrganizations}"
														var="perorganization" varStatus="loop2">
												...
												<td><c:forEach items="${permission.permissionfiles}"
														...
														<a
															href="${pageContext.request.contextPath}/permissionsystem/request/download/${perfile.permissionFileId}"
												...
												<td><a
													href="${pageContext.request.contextPath}/permissionsystem/approve/${permission.permisisonId}"
													class="btn btn-success" role="button"><i
														class="fa fa-check" aria-hidden="true"></i> อนุมัติ</a> <a
													href="${pageContext.request.contextPath}/permissionsystem/reject/${permission.permisisonId}"
