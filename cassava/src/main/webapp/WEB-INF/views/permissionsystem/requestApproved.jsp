		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">อนุมัติสิทธิ์ส่งออกการสำรวจของระบบ >
								คำขอสิทธิ์ที่ดำเนินการแล้ว</h4>
							<p align="right">
								<a
									href="${pageContext.request.contextPath}/permissionsystem/request"
										...
										<c:forEach items="${permissions}" var="permission"
											...
											<tr>
												...
												<td><a class="btn btn-danger " role="button"
													href="${pageContext.request.contextPath}/permissionsystem/request/delete/${permission.permisisonId}/page/approved"
