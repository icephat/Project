		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">โรคมันสำปะหลัง > เพิ่มข้อมูล</h4>
								...
								<form class="form-valide" id="targetOfsurveyData"
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											...
											<div id="Duplicated Name" class="text-danger"></div>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="code">รหัสโรคมันสำปะหลัง
										</label>
										<div class="col-lg-6">
										<input type="text" class="form-control" 
												name="disease.code" placeholder="" required>
											<input class="inputerror" id="code" cssClass="error" disabled />
										</div>
									</div>
									
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="symptom">ลักษณะอาการ
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" 
												name="disease.symptom" placeholder="" required>
											<input class="inputerror" id="symptom" cssClass="error" disabled />
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="controlDisease">การควบคุมโรค
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" 
												name="disease.controlDisease" placeholder="" required>
												<input class="inputerror" id="controlDisease" cssClass="error" disabled />
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="controlPest">การควบคุมแมลงพาหะ
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" 
												name="disease.controlPest" placeholder="" required>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" 
												name="disease.source" placeholder="" required>
							...
							<form class="form-valide" id="image_data"
									...
									<div class="form-group row">
										<div class="col-lg-8 ml-auto">
											<a
												href="${pageContext.request.contextPath }/disease/index"
...
uploadedArea = document.querySelector(".uploaded-area");
    ...
    //		   $('#myModal').modal('show');
			   ...
			   $
										.ajax({
											url : "${pageContext.request.contextPath}/disease/check",
											type : 'POST',
											data : formData,
											dataType : 'json',
											success : function(response) {
												...
												// $
												// 		.ajax({
												// 			url : "${pageContext.request.contextPath}/disease/save",
												// 			type : 'POST',
												// 			data : formData,
												// 			success : function(response) {
    		   $.ajax({
   	            ...
   	            success: function(response) {
   	            	...
   	            	const id = response["body"];
	            		...
	            		let files = $("#nmfiles")[0].files ;
   	            		if(files.length == 0){
   	            			//window.location.href = "${pageContext.request.contextPath }/disease/diseaseSave";
   	            			window.location.href = "${pageContext.request.contextPath }/disease/create/pestpathogen/"+id;
   	            		}
   	            		//alert(files[0].name);
   	            		$('#myModal').modal('show');
    	            	...
    	            	let name = files[i].name ;
   	      		  		$.ajax({
   	     	            		url: "${pageContext.request.contextPath}/imgdisease/",
   	     	            		type: 'POST',
   	     	            		data: uploadFormData,
		  	      	            xhr: function() {
...
//     	        $.ajax({
//     	            url: "${pageContext.request.contextPath }/disease/diseaseSave",
//     	            type: 'POST',
//     	            data: formData,
//     	            xhr: function() {
...
//     	            	window.location.href = "${pageContext.request.contextPath }/disease/diseaseIndex";
