		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">พันธุ์มันสำปะหลัง > ${disease.targetofsurvey.name} > แก้ไขภาพ</h4>
							<div class="row">
										...
										<div class="card">
											<div class="card-body">
												<div class="text-center">
													...
													<h3>
														<a
															href="${pageContext.request.contextPath}/disease/image/delete/${img.imgDiseaseId}"
							...
							<div class="form-validation">
								<form class="form-valide"
									action="${pageContext.request.contextPath }/disease/image/save"
									method="post" modelAttribute="DiseaseDTO"
									enctype="multipart/form-data">

									<input type="hidden" name="disease.diseaseId"
									...
									<div class="form-group row">
										<div class="col-lg-8 ml-auto">
											<a
												href="${pageContext.request.contextPath}/disease/edit/${disease.diseaseId}"
