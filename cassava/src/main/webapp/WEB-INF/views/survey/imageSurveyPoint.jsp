		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">การสำรวจ > การเพาะปลูก ${surveyTargetPoint.surveytarget.survey.planting.name}(${surveyTargetPoint.surveytarget.survey.planting.code})
									- ข้อมูลสำรวจ > ${surveyTargetPoint.surveytarget.targetofsurvey.name} > จัดการภาพ </h4>
							<h4 align='center'> ภาพจุดที่ ${surveyTargetPoint.pointNumber+1} ต้นที่ ${surveyTargetPoint.itemNumber+1}
							</h4>
							
							<div class="row">
								<c:forEach items="${imgSurveyTargetPoint}" var="img" varStatus="loop">
									<div class="col-2">
										<div class="card">
											<div class="card-body">
												<div class="text-center">
													...
													<h3>
														<a
															href="${pageContext.request.contextPath}/survey/image/delete/${img.imgSurveyTargetPointId}"
							...
							<div class="form-validation">
								<form class="form-valide"
									action="${pageContext.request.contextPath }/survey/image/save"
									method="post" modelAttribute="ImgSurveyTargetPointDTO"
									enctype="multipart/form-data">
									
									<input type="hidden" name="surveyTargetPoint.surveyTargetPointId"
										value="${surveyTargetPoint.surveyTargetPointId}">	
									...
									<div class="form-group row">
										<div class="col-lg-8 ml-auto">
											<a
												href="${pageContext.request.contextPath}/survey/point/${id}/info"
