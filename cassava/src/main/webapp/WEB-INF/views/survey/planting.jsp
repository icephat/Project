										...
										<div class="form-group row">
											...
											<div class="col-lg-3">
												<input type="text" class="form-control" id="keyword"
													name="keyword"
													placeholder="รหัส,ชื่อการเพาะปลูกและชื่อแปลง">
											</div>
											<div class="col-lg-3">
		...
		$(function() {
			...
			$
					.ajax(
							{
								method : "GET",
								url : "${pageContext.request.contextPath}/survey/planting/total",
							})
					.then(
			...
			var options = {
				...
				callback : function(response, pagination) {
					...
					$
							.ajax({
								method : "GET",
								url : "${pageContext.request.contextPath}/survey/planting/page/"
										+ pageNumber
										+ "/value/"
										+ pageSize
