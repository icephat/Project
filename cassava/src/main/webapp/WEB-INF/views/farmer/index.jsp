		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">เกษตรกร</h4>

							<p align="right">
								<a href="${pageContext.request.contextPath}/farmer/approve"
									class="btn mb-1 btn-primary">เกษตรกรรออนุมัติ</a>
							</p>
										...
										<div class="form-group row">
											...
											<div class="col-lg-3">
												<input type="text" class="form-control" id="keyword"
													name="keyword" placeholder="ชื่อ-สกุล">
											</div>
											<div class="col-lg-3">
		...
		$(function() {
			...
			$
					.ajax(
							{
								method : "GET",
								url : "${pageContext.request.contextPath}/farmer/total",
							})
					.then(
			...
			var options = {
				...
				callback : function(response, pagination) {
					...
					$
							.ajax({
								method : "GET",
								url : "${pageContext.request.contextPath}/farmer/page/"
										+ pageNumber
										+ "/value/"
										+ pageSize
										+ keyPath,
