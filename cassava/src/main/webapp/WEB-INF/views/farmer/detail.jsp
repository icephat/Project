					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">เกษตรกร > อนุมัติเกษตรกร > รายละเอียด</h4>
										<p align="right">
											<a href="${pageContext.request.contextPath}/farmer/approve"
												class="btn mb-1 btn-light">กลับ</a>
										</p>
										<div class="form-validation">
											<form class="form-valide" id="famerData" modelAttribute="farmer"
												enctype="multipart/form-data">
												<input type="hidden" name="pdpastatus" value="${farmer.pdpastatus}">
												<div class="form-group row">
													<label class="col-lg-4 col-form-label"
														for="user.username">บัญชีผู้ใช้<span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
									...
									<div class="form-group row">
									 ...
									 -->
												<div class="form-validation">
													<div class="form-group row">
														<label class="col-lg-4 col-form-label"
															for="address">ที่อยู่<span class="text-danger">*</span>
														</label>
														<div class="col-lg-6">
															<input type="text" class="form-control" name="address"
																placeholder="" value="${farmer.address}">
															<input class="inputerror" id="address" cssClass="error"
																disabled />
														</div>
													</div>
														...
														<div class="col-lg-6">
															<select name="subdistrict.district.province" id="province"
																...
																<c:forEach items="${provinces}" var="province">
																	<option value="${province.provinceId}" <c:if
																		test="${province.provinceId==provinceFarmer.provinceId}">
																		selected
														...
														<div class="col-lg-6">
															<select name="subdistrict.district.districtId" id="district"
																...
																<c:forEach items="${district}" var="district">
																	<option value="${district.districtId}" <c:if
																		test="${district.districtId==districtFarmer.districtId}">
																		selected
													...
													<div class="form-group row">
														<label class="col-lg-4 col-form-label"
															for="val-username">ตำบล<span class="text-danger">*</span>
														</label>
														<div class="col-lg-6">
															<select name="subdistrict.subdistrictId" id="subdistrict"
																class="form-control" required>
																<c:forEach items="${subdistrict}" var="subdistrict">
																	<option value="${subdistrict.subdistrictId}" <c:if
																		test="${subdistrict.subdistrictId==subdistrictFarmer.subdistrictId}">
																		selected
												...
												<div class="form-group row">
													<label class="col-lg-4 col-form-label"
														for="user.phoneNo">เบอร์โทรศัพท์
													</label>
													<div class="col-lg-6">
												...
												<div class="form-group row">
													<label class="col-lg-4 col-form-label" for="type">สถานะบัญชี<span class="text-danger">*</span>
													</label>
													<div class="col-lg-6">
														<input type="text" class="form-control" value="รออนุมัติ"
															readonly>
													</div>
												</div>
												<input type="hidden" name="user.userStatus"
													value="${farmer.user.userStatus}">

												<!-- 								
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="user.latestLogin">วันที่ใช้ครั้งสุดท้าย
										</label>
										<div class="col-lg-6" >
											<input type="text" class="form-control" value="${formatter.format(farmer.user.latestLogin)}" readonly>
										</div>
									</div>	 
									-->
								...
								function () {
									...
									$.ajax({
										...
										success: function (response) {
											window.location.href = "${pageContext.request.contextPath}/farmer/approve";
										},
