		...
		<div class="container-fluid">
			<div class="row justify-content-center">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">ศัตรูพืช > เพิ่มข้อมูล</h4>
							<p>${errMsg}</p>
							<div class="form-validation">
								<form class="form-valide" id="pestData" modelAttribute="pest"
									...
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="source">แหล่งข้อมูล<span
											class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" 
...
uploadedArea = document.querySelector(".uploaded-area");
    ...
    //		   $('#myModal').modal('show');
    		   ...
    		   $
				.ajax({
					url : "${pageContext.request.contextPath}/pest/check",
					type : 'POST',
					data : formData,
					dataType : 'json',
    		   ...
    		   $.ajax({
   	            url: "${pageContext.request.contextPath }/pest/save",
   	            type: 'POST',
   	            data: formData,
   	            success: function(response) {
   	            		...
   	            		if(files.length == 0){
   	            			window.location.href = "${pageContext.request.contextPath }/pestcide/pestmanagement/create/"+$('#targetId').val();
   	            		}
   	            		//alert(files[0].name);
   	            		//alert(files.length);
   	            		$('#myModal').modal('show');
    	            	...
    	            	let name = files[i].name ;
   	      		  		$.ajax({
   	     	            		url: "${pageContext.request.contextPath}/imgpest/",
   	     	            		type: 'POST',
   	     	            		data: uploadFormData,
		  	      	            xhr: function() {
