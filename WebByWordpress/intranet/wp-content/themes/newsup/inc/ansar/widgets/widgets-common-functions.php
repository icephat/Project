                    ...
                    <div class="small-post clearfix">
                        ...
                        <div class="small-post-content">
                            <div class="mg-blog-category">
                                ...
                                // Compare the dates and display a message if they are equal
                                if ($post_date === $current_date) { ?>
                                    <span class="flashing-text" style="background-color: red; font-size: small; border-radius: 5px; color:white; padding: 2px;">
                                        new!
                                    </span>
                                <?php }
                                ?>
                            ...
                            <div class="title_small_post">
                                ...
                                <h5>
                                    <a href="<?php the_permalink(); ?>">
                                        <?php the_title();
                                        // print_r(newsup_post_meta() . newsup_date_content()); 
                                        ?>
