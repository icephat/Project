					...
					<div class="col-lg-10 mx-auto">
						<div class="card rounded shadow border-0">
							<div class="card-header bg-white">
								<p class="float-end" style="color: green; font-weight: bold;"
									th:text="'ขายได้ : '+${count}+' รายได้ : '+${price}">ขายได้
									2 จาน รายได้ 80 บาท</p>
							</div>
									...
									<table class="table table-hover table-bordered results">
										<thead>
											<tr>
												...
												<th class="col-md-2 col-2">สถานะ</th>
											</tr>
										...
										<tbody>
											<tr th:each="order : ${orderFoods}">
												<td th:text="${order.orderCode}">OD002</td>
												<td>
												...
												<td><span style="color: green;">สำเร็จ</span></td>
											</tr>
