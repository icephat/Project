		...
		<div
			...
			<div class="justify-content-end">
				<nav id="navbar" class="navbar">
					<ul>
						<li><a href="./order">ออเดอร์<span th:text="${q}"
								style="text-align: center; border-radius: 100%; background-color: rgb(255, 0, 0); width: 20px; color: rgb(255, 255, 255); font-size: small;">0</span></a>
						</li>
		...
		<section id="about" class="contact">
			<div class="container" data-aos="fade-up">
				...
				<div class="row gy-4">
					...
					<div th:each="menu : ${menus}" class="col-md-6"
						onclick="location.href='./menuDetail.html';"
						style="cursor: pointer">
						<a th:href="@{'./orderfront/'+${menu.menuId}}">
							<div class="info-item  d-flex align-items-center">
								<i class="icon fa-solid fa-bowl-food flex-shrink-0"></i>
								<div>
									<h3 th:text="${menu.name }">กะเพรา</h3>
								</div>
							</div>
						</a>
					</div>
