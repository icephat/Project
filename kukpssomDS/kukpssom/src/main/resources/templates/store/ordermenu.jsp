							...
							<div
								...
								<div class="card-body" style="text-align: center;">
									<form class="form-valide" method="POST"
										modelAttribute="orderDTO" enctype="multipart/form-data"
										th:action="@{'/store/createOrder'}">
										<h2 class="card-title" th:text="${'ชื่อเมนู : '+ menu.name}"></h2>
										<input type="hidden" name="menuId" th:value="${menu.menuId}" />
										<input type="hidden" name="price" th:value="${menu.price}" />

										<fieldset class="checkbox-group">
											<legend class="checkbox-group-legend">เลือก Topping</legend>
											<div class="checkbox">
												<label class="checkbox-wrapper"> <input type="radio"
													class="checkbox-input" name="addOn" th:value="none" checked />
													<span class="checkbox-tile"> <span
														class="checkbox-label">ไม่เพิ่ม</span>
												</span>
												</label>
											</div>
											<div class="checkbox">
											...
											<div class="checkbox">
												<label class="checkbox-wrapper"> <input type="radio"
													...
													<span class="checkbox-tile"> <span
														class="checkbox-label">ไข่ข่าว</span>
												</span>
												</label>
											</div>
										</fieldset>
										<br>
										<fieldset class="checkbox-group">
											<legend class="checkbox-group-legend">ระดับอาหาร</legend>
											<div class="checkbox">
												<label class="checkbox-wrapper"> <input type="radio"
													class="checkbox-input" name="level" th:value="normal"
													checked /> <span class="checkbox-tile"> <span
														class="checkbox-label">ธรรมดา</span>
												</span>
												</label>
											</div>
											<div class="checkbox">
										...
										<br>
										<button type="submit" class="btn btn-outline-success">สั่งออเดอร์</button>
									</form>
								</div>
