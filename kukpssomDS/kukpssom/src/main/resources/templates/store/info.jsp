							...
							<div class="card">
								<div class="card-body">
									<div class="form-validation">
										<form class="form-valide" action="./editinfomation.html"
											method="" novalidate="novalidate">
											...
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="val-email"
														name="val-email" th:value="${store.name}" disabled>
												</div>
											</div>
											<br>
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="val-email"
														name="val-email" th:value="${store.timeOpen}" disabled>
												</div>
											</div>
											<br>
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="val-password"
														name="val-password" th:value="${store.timeClose}" disabled>
												</div>
											</div>
											<br>
											...
											<div class="form-group row"
												...
												<div class="col-lg-8 ml-auto">
													<a href="./edit" type="button" class="btn btn-warning">แก้ไข</a>
