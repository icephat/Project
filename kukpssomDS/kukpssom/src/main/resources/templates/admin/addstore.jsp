								...
								<div class="card-body">
									<div class="form-validation">
										<form class="form-valide" method="POST"
											modelAttribute="storeDTO" enctype="multipart/form-data"
											th:action="@{/admin/createStore}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" id="val-password"
														name="surname" placeholder="" required="required">
												</div>
											</div>
											<br>
											<div class="form-group row">
												<label class="col-lg-4 col-form-label" for="val-password">
													ชื่อร้านอาหาร<span class="text-danger">*</span>
												</label>
												<div class="col-lg-6">
													<input type="text" class="form-control" id="val-password"
														name="storeName" placeholder="" required="required">
												</div>
											</div>
											<br>
											<div class="form-group row">
												<label class="col-lg-4 col-form-label" for="val-password">
													ประเภทร้านอาหาร<span class="text-danger">*</span>
												</label>
												<div class="col-lg-6">
											...
											<div class="form-group row">
												<label class="col-lg-4 col-form-label" for="val-password">
													เวลาเปิด<span class="text-danger">*</span>
												</label>
												<div class="col-lg-6">
													<input type="time" class="form-control" id="val-password"
														name="open" placeholder="" required="required">
												</div>
											</div>
											<br>
											<div class="form-group row">
												<label class="col-lg-4 col-form-label" for="val-password">
													เวลาปิด<span class="text-danger">*</span>
												</label>
												<div class="col-lg-6">
													<input type="time" class="form-control" id="val-password"
														name="close" placeholder="" required="required">
												</div>
											</div>
											<br>
											<!--<div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-password"> ชื่อ-นามสกุล เจ้าของร้าน<span
                                                class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-password"
                                                name="val-password" placeholder="">
                                        </div>
                                    </div>-->
