		...
		<div class="box-root flex-flex flex-direction--column"
			...
			<div
				...
				<div
					...
					<h1>
						<a href="./login" rel="dofollow">Sharity Login</a>
					</h1>
				</div>
				<div class="formbg-outer">
					<form method="POST" modelAttribute="user"
						enctype="multipart/form-data" th:action="@{home}">
						<div class="formbg">
							<div class="formbg-inner padding-horizontal--48">

								<!-- <span class="padding-bottom--15">เข้าสู่ระบบ</span> -->
								<p th:text="${alert}"
									style="color: red; margin-top: -9px; margin-bottom: 15px;"></p>
					...
					<div class="footer-link padding-top--24">
						<span>Don't have an account? <a href="register">ลงทะเบียน</a></span>
