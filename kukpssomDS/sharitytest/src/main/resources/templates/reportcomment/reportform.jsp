			...
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">รายงานความคิดเห็น</h4>
								<div class="form-validation">

									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="username">ชื่อผู้ใช้
											<span class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="username"
												name="username" th:placeholder="${comment.user.username}"
												disabled>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="firstName"
												name="firstName" th:placeholder="${comment.user.firstName}"
												disabled>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" id="lastName"
												name="lastName" th:placeholder="${comment.user.lastName}"
												disabled>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4 col-form-label" for="lastName">ความคิดเห็นที่ถูกรายงาน
											<span class="text-danger">*</span>
										</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" id="lastName"
												name="lastName" th:placeholder="${comment.detail}" disabled>
										</div>
									</div>
									<form method="POST" modelAttribute="reportCommentDTO"
										enctype="multipart/form-data" action="addreportcomment">
										<p th:text=${alert} style="color: red; margin-top: -9px; margin-bottom: 15px; align-items: center;"></p>
										<div class="form-group row">
											<label class="col-lg-4 col-form-label" for="userReport">รายละเอียด
												<span class="text-danger">*</span>
											</label>
											<div class="col-lg-6">
