		...
		<div class="content-body" style="min-height: 876px;">
			...
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="">การเข้าร่วมกิจกรรม</a></li>
						<li class="breadcrumb-item active"><a href="">ประเมินกิจกรรม</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
						...
						<div class="card">
							<div class="card-body">
								<div class="form-validation">
									<form action="estimateConfirm" method="POST"
										modelAttribute="joinActivity" enctype="multipart/form-data">
										<div class="form-group row">
											<input type="hidden" id="activity" name="activity"
												th:value="${activityId}"> <label
												class="col-lg-4 col-form-label" for="detail">score <span
										...
										<div class="form-group row">
											<label class="col-lg-4 col-form-label" for="comment">ความคิดเห็นต่อกิจกรรม
												<span class="text-danger">*</span>
											</label>
											<div class="col-lg-6">
												<input type="text" class="form-control" id="comment"
													name="comment" placeholder="comment" required>
											</div>
										</div>
										<div class="form-group row">
